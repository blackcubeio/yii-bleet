...
use Blackcube\Bleet\Widgets\ToggleList;
...
class Bleet
{
    ...
    /**
     * Creates a ToggleList: one switch per value of an array property
     */
    public static function toggleList(?FormModelInterface $model = null, ?string $property = null): ToggleList
    {
        $field = ToggleList::widget();
