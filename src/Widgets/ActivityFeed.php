 ...
 * @link https://www.blackcube.io
 */
class ActivityFeed extends AbstractWidget
{
    ...
    /**
     * Sets the URL of the "see all" link
     */
    ...
    /**
     * Sets the label of the "see all" link
     */
    ...
    /**
     * Disables the connecting line between the items
     */
    ...
    private function renderItems(): string
    {
        ...
        foreach ($this->items as $index => $item) {
            ...
            $hasNext = $this->showConnector === true && $isLast === false;
