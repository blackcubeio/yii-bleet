...
class Header extends AbstractWidget
{
    ...
    /** @var array<Anchor|Button|AbstractBleetButton> */
     ...
     * @param array<Anchor|Button|AbstractBleetButton> $actions
     */
     ...
     * Adds une action
     */
    public function addAction(Anchor|Button|AbstractBleetButton $action): self
    {
        $new = clone $this;
        $new->actions[] = $action;
        return $new;
    ...
    {
        $hasExtras = $this->searchAction !== null || empty($this->actions) === false || empty($this->widgets) === false || $this->profile !== null;
