 ...
 * @link https://www.blackcube.io
 */
class Toast extends AbstractWidget
{
    ...
    /**
     * Sets the delay before auto closing (in ms, 0 = no auto close)
     */
    ...
    /**
     * Attributes triggering a toast on click
    ...
    {
        return Html::tag('bleet-toast', '', $this->prepareTagAttributes(Aurelia::attributesCustomElement($this->asArray())))->render();
    }
