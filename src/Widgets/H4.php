...
/**
 * H4 widget - Subsection header with bottom border (smaller)
 *
 * Usage:
 *   Bleet::h4('Mon titre')->render();
 *   Bleet::h4('Mon titre')->subtitle('Description')->render();
 *   Bleet::h4('Mon titre')->secondary()->render();
 *
 * @copyright 2010-2025 Philippe Gaultier
 * @license https://www.blackcube.io/license
 * @link https://www.blackcube.io
 */
final class H4 extends AbstractWidget
{
    ...
    public function render(): string
    {
        ...
        if (!empty($this->title)) {
            $html .= Html::tag('h4', Html::encode($this->title), ['class' => $this->getTitleClasses()]);
        }
    ...
    {
        $baseClasses = ['border-b', 'pb-4', 'mb-4'];
    ...
    {
        $baseClasses = ['mt-2', 'max-w-4xl', 'text-xs'];
        $colorClasses = match ($this->color) {
            Bleet::COLOR_PRIMARY => ['text-primary-700'],
            Bleet::COLOR_SECONDARY => ['text-secondary-700'],
            Bleet::COLOR_SUCCESS => ['text-success-700'],
