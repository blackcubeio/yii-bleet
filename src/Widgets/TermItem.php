...
class TermItem
{
    ...
    /**
     * Shortcut to add a plain string detail
     */
    ...
    /**
     * Returns whether the term encoding is enabled
     */
    ...
    {
        return $this->encodeTerm === true ? htmlspecialchars($this->term, ENT_QUOTES | ENT_HTML5) : $this->term;
    }
    ...
    {
        return empty($this->rowAttributes) === false;
    }
}
