...
/**
 * Modal widget - Dialog modal centre (AJAX version)
 *
 * Usage:
 *   // Trigger with URL
 ...
 * @link https://www.blackcube.io
 */
final class Modal extends AbstractWidget
{
    ...
    /**
     * Attributs pour declencher l'ouverture du modal
    ...
    public function trigger(?string $url = null): array
    {
        ...
        return ['bleet-modal-trigger' => Aurelia::attributesCustomAttribute($options)];
    }
    ...
    {
        return Html::tag('bleet-modal', '', $this->prepareTagAttributes(['id' => $this->id]))->render();
    }
