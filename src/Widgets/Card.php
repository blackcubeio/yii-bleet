...
class Card extends AbstractWidget implements WidgetInterface
{
     ...
     */
    /**
     * Shade of the rules separating the sections.
     *
     * @return string[]
     */
    protected function getDivideClasses(): array
    {
        return match ($this->color) {
            Bleet::COLOR_PRIMARY => ['divide-primary-200'],
            Bleet::COLOR_SECONDARY => ['divide-secondary-200'],
            Bleet::COLOR_ACCENT => ['divide-accent-200'],
            Bleet::COLOR_SUCCESS => ['divide-success-200'],
            Bleet::COLOR_DANGER => ['divide-danger-200'],
            Bleet::COLOR_WARNING => ['divide-warning-200'],
            Bleet::COLOR_INFO => ['divide-info-200'],
        };
    }
