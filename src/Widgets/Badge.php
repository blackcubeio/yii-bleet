...
class Badge extends AbstractWidget
{
    ...
    /**
     * Enables the remove button (for tags)
     */
    ...
    {
        $showDot = $this->dot === true && $this->removable === false;
    ...
    protected function prepareClasses(): array
    {
        ...
        $roundedClasses = $this->pill === true ? ['rounded-full'] : ['rounded-md'];

        $gapClasses = [];
        if ($showDot) {
            $gapClasses = ['gap-x-1.5'];
        } elseif ($this->removable === true) {
