 ...
 *
 * Usage:
 *   Bleet::ol(['Étape 1', 'Étape 2'])->render();
 *   Bleet::ol(['Étape 1', 'Étape 2'])->sm()->render();
 *   Bleet::ol(['Étape 1', 'Étape 2'])->primary()->render();
 *   Bleet::ol([
 *       'Étape simple',
 ...
 * @link https://www.blackcube.io
 */
final class OrderedList extends AbstractWidget
{
