 ...
 *
 * Usage:
 *   Bleet::ol(['Step 1', 'Step 2'])->render();
 *   Bleet::ol(['Step 1', 'Step 2'])->sm()->render();
 *   Bleet::ol(['Step 1', 'Step 2'])->primary()->render();
 *   Bleet::ol([
 *       'Plain step',
 *       ['With icon', ['solid' => 'check-circle']],
 *       ['Color override', ['solid' => 'x-circle', 'color' => 'danger']],
 *   ])->success()->render();
 *   Bleet::ol()
 *       ->addItem(Bleet::listItem('Text')->solid('check-circle'))
 *       ->success()
 *       ->render();
 *
 * @copyright 2010-2026 Blackcube - Philippe Gaultier
 ...
 * @link https://www.blackcube.io
 */
class OrderedList extends AbstractWidget
{
