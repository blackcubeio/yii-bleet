 ...
 * @link https://www.blackcube.io
 */
class Alert extends AbstractWidget implements WidgetInterface
{
    ...
    {
        if (in_array($color, self::ALLOWED_COLORS, true) === false) {
    ...
    public function render(): string
    {
        ...
        $contentContainerClasses = $this->dismissible === true ? ['ml-3', 'flex-1'] : ['ml-3'];
        ...
        $attributes = $this->prepareTagAttributes(
            $this->dismissible === true ? ['bleet-alert' => ''] : []
        );
