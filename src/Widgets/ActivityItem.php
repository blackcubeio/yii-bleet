 ...
 * @link https://www.blackcube.io
 */
class ActivityItem extends AbstractWidget
{
    ...
    /**
     * Returns the color (for ActivityFeed)
     */
    ...
    /**
     * Returns whether encoding is enabled (for ActivityFeed)
     */
    ...
    {
        return $this->encode === true ? Html::encode($this->content) : $this->content;
    }
