...
class Select extends BaseSelect
{
    ...
    /** @var array<int, string|int> the option values rendered `disabled` — visible, never selectable */
    ...
    /**
     * Sets the option values that are shown but cannot be selected.
     *
    ...
    protected function prepareViewParams(): array
    {
        ...
        $params = [
            ...
            'itemDisabledClasses' => $this->disabledClasses(),
