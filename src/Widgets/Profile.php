...
class Profile extends AbstractWidget
{
    ...
    /**
     * Sets the dropdown menu items (Anchor or Button)
     * @param array<Anchor|Button|AbstractBleetButton> $items
     */
     ...
     */
    public function addItem(Anchor|Button|AbstractBleetButton $item): self
    {
        $new = clone $this;
        $new->items[] = $item;
        return $new;
